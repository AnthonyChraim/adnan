...
export const PageNotFoundRealtor = (props) => {
  const language = useContext(LanguageContext);
  const data = language.language === "en" ? jsonDataEn.ErrorRealtor.page : jsonDataFr.ErrorRealtor.page;
  ...
  return (
    <section id="realtor-notfound" className="d-flex align-items-center">
      <div className="container d-flex flex-column align-items-center justify-content-center" data-aos="fade-up">
        ...
        <div className="col-sm-12 not-found-section">
          <div className="row">
            <div className="col-md-6">
              <div className="agent-avatar-box">
                <img src={data.profile.image} alt="Face Image" className="agent-avatar img-fluid rounded-3" />
              </div>
            </div>
              ...
              <div className="agent-info-box">
                ...
                <div className="agent-content mb-3">
                  ...
                  {Object.keys(data.profile.contact).map((key) => (
                    <div className="info-agents color-a" key={key}>
                      <p>
                        <strong>{key}: </strong>
